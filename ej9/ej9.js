function verEnunciado(){
    let enunciadoAE = `   Realiza una aplicación web dónde se solicite por pantalla, mediante una ventana emergente, al usuario una secuencia de notas (con valores que van de 0 a 10, sin decimales). La entrada acabará con el valor “-1”.
La aplicación mostrará en la parte destinada para tal efecto, "SI", si hay algún 10, "NO" en caso contrario.
